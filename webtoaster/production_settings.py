...
DATABASES = {
    'default': {
        ...
        'USER': 'palfa',                      # Not used with sqlite3.
        'PASSWORD': 'p41f4@pu1s4r',                  # Not used with sqlite3.
        'HOST': 'lore4',                      # Set to empty string for localhost. Not used with sqlite3.
...
MEDIA_ROOT = '/home/palfa/webtoaster/media/'

# URL that handles the media served from MEDIA_ROOT. Make sure to use a
# trailing slash if there is a path component (optional in other cases).
# Examples: "http://media.lawrence.com", "http://example.com/media/"
MEDIA_URL = 'http://palfa.physics.mcgill.ca/webtoaster/media/'
...
ROOT_URLCONF = 'urls'
CYBERSKA_APP_URL= "http://www.cyberska.org/pg/oauth/application?appID=24563"
